...
begin
  ...
  MoveTo(X0,round(MY*GetMaxY));
  SetColor(LightBlue);
  for m := 1 to 1024 do begin
    LineTo(X0+m,GetMaxY-round(FuncData[m]*dy*My)-(GetmaxY div 2));
  ...
  sas := j*k;
    ...
    OutTextXY(X0,round(GetMaxY-(GetMaxY/2 - MY*5*GetMaxY/9.6)),dod);
  end;
